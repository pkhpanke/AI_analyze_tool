...
if __name__ == '__main__':
    # batch_size = 69
    analyzer = GPTReviewsAnalyzer(key="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", host= "remote3")
